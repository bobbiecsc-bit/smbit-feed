...
# Order here is the priority order.
...
CATEGORY_KEYWORDS = {
    'infrastructure': [
        'wi-fi', 'wifi', 'wi-fi 7', 'small business NAS', 'NAS drive',
        'VoIP', 'UPS backup', 'uninterruptible power', 'LAN setup',
        'local area network', 'point of sale', 'POS hardware', 'server rack',
        'patch panel', 'structured cabling', 'network switch', 'wireless access point',
        'office router', 'on-premise', 'on-prem', 'hardware refresh',
        'printer server', 'VoIP phone system',
    ],
    'cloud_saas': [
        ...
        'SSO', 'single sign-on', 'cloud storage', 'OneDrive', 'SharePoint',
    ...
    'continuity': [
        'business continuity', 'disaster recovery', 'DR plan',
        '3-2-1 backup', 'offsite backup', 'offsite storage',
        'recovery time objective', 'RTO', 'RPO', 'data recovery',
        'backup strategy', 'ransomware recovery', 'failover',
        'business interruption', 'emergency IT', 'incident response plan',
